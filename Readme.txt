...
Instructions:
    ...
    - Final results (figures and csv files) will appear in folder Output. Files Data and Results will       appear also with the initial data and auxiliary files.
 
If you prefer run the simulation manually for any reason, follow the general instructions below:
